...
Do NOT use this skill when `security:big-toni` is available — the reviewer-team orchestrators pick the richer skill first.
...
- `reviewer` — `"plan-executor:lite-security-reviewer"`
